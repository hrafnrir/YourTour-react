...
const data = {
  ...
  mainContent: {
    ...
    gallery: {
      ...
      photoItems: [
        {
          device: "phone",
          photo: GalleryImages.img1,
          alt: "Летящий пассажирский самолет над морем",
        },
        {
          device: "desktop",
          photo: GalleryImages.img2,
          alt: "Вид на кемпинг из палатки",
        },
        {
          device: "tablet",
          photo: GalleryImages.img3,
          alt: "Путешественник встречает закат",
        },
        {
          device: "phone",
          photo: GalleryImages.img4,
          alt: "Бескрайняя пустая дорога",
        },
        {
          device: "phone",
          photo: GalleryImages.img5,
          alt: "Путешественники встречают рассвет на скалах",
        },
        {
          device: "tablet",
          photo: GalleryImages.img6,
          alt: "Девушка смотрит бумажную карту в машине",
        },
        {
          device: "desktop",
          photo: GalleryImages.img7,
          alt: "Дорога по высокому мосту в лесной местности",
        },
        {
          device: "phone",
          photo: GalleryImages.img8,
          alt: "Кемпинг у водоема, путешествие на автомобиле",
        },
        {
          device: "phone",
          photo: GalleryImages.img9,
          alt: "Брусчатая дорога в переулке",
        },
        {
          device: "phone",
          photo: GalleryImages.img10,
          alt: "Вечерний уютный город",
        },
        {
          device: "phone",
          photo: GalleryImages.img11,
          alt: "Путешественник любуется красотой фьорда в солнечный летний день",
        },
        {
          device: "tablet",
          photo: GalleryImages.img12,
          alt: "Оживленная вечерняя улица",
        },
        {
          device: "desktop",
          photo: GalleryImages.img13,
          alt: "Девушка в купальнике сплавляется по озеру",
        },
      ],
    },
    story: {
  ...
  callToAction: {
    img: {
      photo: CTAImages.img1,
      alt: "Живописный вид на зеленые луга, лес, водоем и белеющие в далеке вершины гор",
    },
